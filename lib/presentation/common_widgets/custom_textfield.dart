...
typedef FieldOnTap = Function();
typedef OnFocusChange = Function(bool focus);
var emojiRegexp =
...
class CustomTextField extends StatelessWidget {
  ...
  CustomTextField({
    ...
    this.label,
    this.borderColor,
    this.highLight = AppColors.greyColor,
  ...
  Widget build(BuildContext context) {
    ...
    if (inputFormatters != null) {
      inputFormatters?.addAll(compulsoryInputFormatters);
    } else {
      inputFormatters = compulsoryInputFormatters;
    }
      ...
      children: [
            ...
            ? Column(
                children: [
                  Text(
                    ...
                    style: AppStyles.mediumTextWithColor(highLight),
                  ),
                  const SizedBox(
                    height: 5,
                  )
                    ...
                    Flexible(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          // hintText: hintText,
                          labelText: hintText,
                          labelStyle: AppStyles.headerStyle,
                          ...
                          //       ),
                          // ),
                          hintStyle: AppStyles.regularTextWithColor(
        ...
        (errorText != null)
            ? Padding(
                ...
                child: Text(
                  errorText!,
                  style: AppStyles.smallTextWithColor(AppColors.redColor),
                ),
              )
            : const SizedBox.shrink(),
      ],
